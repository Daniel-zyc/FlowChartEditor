...
class DFMergeItem : public DPolygonBase
{
public:
    enum { Type = DFMergeItemType };
    DFMergeItem(QGraphicsItem *parent = nullptr);
    DFMergeItem(qreal w, qreal h, QGraphicsItem *parent = nullptr);
