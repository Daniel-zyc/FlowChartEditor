...
class DFDirectStorageItem : public DShapeBase
{
public:
    enum { Type = DFDirectStorageItemType };
	DFDirectStorageItem(QGraphicsItem *parent = nullptr);
	DFDirectStorageItem(qreal w, qreal h, QGraphicsItem *parent = nullptr);
